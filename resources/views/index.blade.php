                                    ...
                                    @if (!empty($event))
                                        ...
                                        @if ($event->start->day == $event->end->day)
                                            @if ($event->start->month == $event->end->month)
                                                <h3 class="date">Le {{ $event->start->day . ' ' . $event->start->monthName . ' ' . $event->start->year }} de @if($event->start->minute == 0) {{ $event->start->hour . 'h00' }} @else {{ $event->start->hour . 'h' . $event->start->minute }} @endif à @if($event->end->minute == 0) {{ $event->end->hour . 'h00' }} @else {{ $event->end->hour . 'h' . $event->end->minute}} @endif, {{ $event->place }}</h3>
                                            @else
                                                        ...
                                                        <div class="col-xs-12 col-sm-3">
                                                            <div class="time-area">
                                                                <h4 class="time">
                                                                    @if ($event->start->day == $event->end->day)
                                                                        @if ($event->start->month == $event->end->month)
                                                                            <span>Le</span> {{ $event->start->day . '/' . $event->start->month }} <span>de</span> <br> @if($event->start->minute == 0) {{ $event->start->hour . 'h00' }} @else {{ $event->start->hour . 'h' . $event->start->minute }} @endif à @if($event->end->minute == 0) {{ $event->end->hour . 'h00' }} @else {{ $event->end->hour . 'h' . $event->end->minute}} @endif
                                                                        @else
