...
<!-- Mirrored from nayrathemes.com/demo/html/hantus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Sep 2018 08:58:01 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <meta name="keywords" content="Hantus, Responsive, SPA Template, Bootstrap 4,">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="{{ asset('whirlpool/img/favicon.png') }}" type="image/x-icon" />
    <title>Hantus - Spa and Beauty HTML template</title>

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('whirlpool/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('whirlpool/css/responsive.css') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-6">
                    <div class="logo main">
                        <a href="{{ route('index') }}"><img class="responsive" src="{{ asset('whirlpool/img/logo.png') }}" alt="Startkit"></a>
                    </div>
                </div>
                <div class="col-lg-10 col-md-10 d-none d-lg-block text-right">
                    <nav class="main-menu">
                        <ul>
                            @include('layout.menu', ['active' => 'whirlpool'])
                        </ul>
                    </nav>
                </div>
        ...
        <div class="col-md-12">
            <div class="header-slider">
                <div class="header-single-slider">
                    <figure>
                        <img src="{{ asset('whirlpool/img/sliders/slider01.jpg') }}" alt="">
                        <figcaption>
                            <div class="content">
                ...
                <div class="header-single-slider">
                    <figure>
                        <img src="{{ asset('whirlpool/img/sliders/slider02.jpg') }}" alt="">
                        <figcaption>
                            <div class="content">
                ...
                <div class="header-single-slider">
                    <figure>
                        <img src="{{ asset('whirlpool/img/sliders/slider03.jpg') }}" alt="">
                        <figcaption>
                            <div class="content">
    ...
    <div class="container contact-wrapper text-center text-xl-left">
        <div class="row">
            <div class="col-xl-4 col-md-6 col-sm-6 single-contact">
                <img src="{{ asset('whirlpool/img/icons/icon01.png') }}" alt="">
                <h4>Opening Time</h4>
                <p>Mon - Sat: 10h00 - 18h00</p>
            </div>
            <div class="col-xl-4 col-md-6 col-sm-6 single-contact">
                <img src="{{ asset('whirlpool/img/icons/icon02.png') }}" alt="">
                <h4>Address</h4>
                <p>40 Baria Sreet, NY USAm</p>
            </div>
            <div class="col-xl-4 offset-xl-0 col-md-6 col-sm-6 offset-sm-3 single-contact">
                <img src="{{ asset('whirlpool/img/icons/icon03.png') }}" alt="">
                <h4>Telephone</h4>
                <p>+12 345 678 9101</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div class="service-box text-center">
                    <figure>
                        <img src="{{ asset('whirlpool/img/service/service01.png') }}" alt="">
                        <figcaption>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div class="service-box text-center">
                    <figure>
                        <img src="{{ asset('whirlpool/img/service/service02.png') }}" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <a href="#" class="boxed-btn">Book now</a>
                            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-sm-0">
                <div class="service-box text-center">
                    <figure>
                        <img src="{{ asset('whirlpool/img/service/service03.png') }}" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <a href="#" class="boxed-btn">Book now</a>
                            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="service-box text-center">
                    <figure>
                        <img src="{{ asset('whirlpool/img/service/service04.png') }}" alt="">
                        <figcaption>
                            <div class="inner-text">
                                <a href="#" class="boxed-btn">Book now</a>
                            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="tab-content">
                    <div id="hair" class="tab-pane">
                        <ul>
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio01.png') }}" alt="">
                                <a href="#"><h4>Massage <span class="price">$24.95</span></h4></a>
                                <p>Oil, candle, stone, water,...</p>
                            </li>
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio02.png') }}" alt="">
                    ...
                    <div id="makeup" class="tab-pane">
                        <ul>
                            ...
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio05.png') }}" alt="">
                                <a href="#"><h4>Massage Relax<span class="price">$24.95</span></h4></a>
                                <p>Oil, candle, stone, water,...</p>
                            </li>
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio04.png') }}" alt="">
                    ...
                    <div id="massage" class="tab-pane fade-in active">
                        <ul>
                            ...
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio06.png') }}" alt="">
                                <a href="#"><h4>Massage relax <span class="price">$34.95</span></h4></a>
                                <p>Oil, candle, stone, water,...</p>
                            </li>
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio03.png') }}" alt="">
                                <a href="#"><h4>Massage Lavender <span class="price">$35.95</span></h4></a>
                                <p>Oil, candle, stone, water,...</p>
                            </li>
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio07.png') }}" alt="">
                            ...
                            <li>
                                <img src="{{ asset('whirlpool/img/portfolio/portfolio08.png') }}" alt="">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div class="feature-box text-center">
                    <div class="feature-icon">
                        <img src="{{ asset('whirlpool/img/feature-icon/feature-icon01.png') }}" alt="">
                    </div>
                    <h4>Hair Expert</h4>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-lg-0">
                <div class="feature-box text-center">
                    <div class="feature-icon">
                        <img src="{{ asset('whirlpool/img/feature-icon/feature-icon02.png') }}" alt="">
                    </div>
                    <h4>Stone Massage</h4>
                    <p>Lorem Ipsum is simply dummy text  the printing and typesetting.</p>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-5 mb-sm-0">
                <div class="feature-box text-center">
                    <div class="feature-icon">
                        <img src="{{ asset('whirlpool/img/feature-icon/feature-icon03.png') }}" alt="">
                    </div>
                    <h4>Nail Care</h4>
                    <p>Lorem Ipsum is simply dummy text  the printing and typesetting.</p>
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="feature-box text-center">
                    <div class="feature-icon">
                        <img src="{{ asset('whirlpool/img/feature-icon/feature-icon04.png') }}" alt="">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                <div class="pricing-box text-center" style="background: url({{ asset('whirlpool/img/pricing/pricing01.jpg') }}) no-repeat center / cover;">
                    <h3>Silver Pack</h3>
                    <hr>
            ...
            <div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
                <div class="pricing-box recomended text-center" style="background: url({{ asset('whirlpool/img/pricing/pricing02.jpg') }}) no-repeat center / cover;">
            ...
            <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                <div class="pricing-box text-center" style="background: url({{ asset('whirlpool/img/pricing/pricing03.jpg') }}) no-repeat center / cover;">
                    <h3>Platinum Pack</h3>
                    <hr>
                ...
                <div class="product-carousel">
                    <div class="single-product text-center">
                        ...
                        <div class="product-img">
                            <img src="{{ asset('whirlpool/img/product/product01.png') }}" alt="">
                        </div>
                        <ul class="rate">
                        ...
                        <div class="overlay">
                            <ul class="icons">
                                ...
                                <li><a href="{{ asset('whirlpool/img/product/product01.png') }}" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="single-product text-center">
                        <div class="product-img">
                            <img src="{{ asset('whirlpool/img/product/product02.png') }}" alt="">
                        </div>
                        <ul class="rate">
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
                        ...
                        <div class="overlay">
                            <ul class="icons">
                                <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                <li><a href="{{ asset('whirlpool/img/product/product02.png') }}" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="single-product text-center">
                        <span class="sale">Sale!</span>
                        <div class="product-img">
                            <img src="{{ asset('whirlpool/img/product/product03.png') }}" alt="">
                        </div>
                        <ul class="rate">
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
                        ...
                        <div class="overlay">
                            <ul class="icons">
                                <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                <li><a href="{{ asset('whirlpool/img/product/product03.png') }}" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="single-product text-center">
                        <div class="product-img">
                            <img src="{{ asset('whirlpool/img/product/product04.png') }}" alt="">
                        </div>
                        <ul class="rate">
                            <li><i class="fas fa-star"></i></li>
                            <li><i class="fas fa-star"></i></li>
                        ...
                        <div class="overlay">
                            <ul class="icons">
                                <li><a href="#"><i class="ei ei-icon_bag_alt"></i></a></li>
                                <li><a href="{{ asset('whirlpool/img/product/product04.png') }}" class="mfp-popup"><i class="fas fa-eye"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-lg-0">
                <div class="single-beauticians">
                    <div class="img-wrapper">
                        <img src="{{ asset('whirlpool/img/beauticians/beauticians01.jpg') }}" alt="">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-lg-0">
                <div class="single-beauticians">
                    <div class="img-wrapper">
                        <img src="{{ asset('whirlpool/img/beauticians/beauticians02.jpg') }}" alt="">
                        <div class="beautician-footer-text">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-4 mb-sm-0">
                <div class="single-beauticians">
                    <div class="img-wrapper">
                        <img src="{{ asset('whirlpool/img/beauticians/beauticians03.jpg') }}" alt="">
                        <div class="beautician-footer-text">
                            <h5>Eric Matision</h5>
                            <p>Skin Expert</p>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-beauticians">
                    <div class="img-wrapper">
                        <img src="{{ asset('whirlpool/img/beauticians/beauticians04.jpg') }}" alt="">
                        <div class="beautician-footer-text">
                            <h5>Betty Ross</h5>
                            <p>Massagist</p>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                <aside class="widget widget_about">
                    <div class="footer-logo"><img src="{{ asset('whirlpool/img/logo.png') }}" alt=""></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-md-0 mb-4">
                <aside class="widget widget_recent">
                    <h4 class="widget-title"><img src="{{ asset('whirlpool/img/section-icon.png') }}" alt="">Latest News</h4>
                    <ul>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 mb-lg-0 mb-4">
                <aside class="widget widget_links">
                    <h4 class="widget-title"><img src="{{ asset('whirlpool/img/section-icon.png') }}" alt="">Quick Link</h4>
                    <ul>
                        <li><a href="#">Home</a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <aside class="widget widdget-instagram">
                    <h4 class="widget-title"><img src="{{ asset('whirlpool/img/section-icon.png') }}" alt="">Instagram</h4>
                    <ul class="instagram-photos">
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram01.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram02.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        ...
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram03.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram04.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        </li>
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram05.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        ...
                        <li>
                            <img src="{{ asset('whirlpool/img/instagram/instagram06.jpg') }}" alt="">
                            <div class="instagram-overlay">
                                <a href="#">+</a>
                            </div>
                        </li>
...
<!-- Scripts -->
<script src="{{ asset('whirlpool/js/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/popper.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/jquery.sticky.js') }}"></script>
<script src="{{ asset('whirlpool/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/jquery.shuffle.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/jquery.counterup.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/wow.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/jquery.meanmenu.min.js') }}"></script>
<script src="{{ asset('whirlpool/js/jquery.magnific-popup.min.js') }}"></script>

<!-- Custom Script -->
<script src="{{ asset('whirlpool/js/custom.js') }}"></script>

</body>


<!-- Mirrored from nayrathemes.com/demo/html/hantus/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Sep 2018 08:58:02 GMT -->
</html>